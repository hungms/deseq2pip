...
.onLoad <- function(libname, pkgname) {
  ...
  packages <- c(
    "strpip", "plotr", "DESeq2", "biomaRt", "pheatmap", "ggplotify", "clusterProfiler", "msigdbr", "fgsea", "ggpubr", "grid", "scales", "forcats", "limma", "labeling", "sva", "ashr", "enrichplot", "renv", "ggprism")
